...
RcppExport SEXP _SpANR_create_mat_t(SEXP matSEXP, SEXP a_tm1SEXP, SEXP dSEXP, SEXP retentionSEXP) {
BEGIN_RCPP
...
static const R_CallMethodDef CallEntries[] = {
    {"_SpANR_create_mat_t", (DL_FUNC) &_SpANR_create_mat_t, 4},
    {NULL, NULL, 0}
};

RcppExport void R_init_SpANR(DllInfo *dll) {
